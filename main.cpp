...
const std::vector<Vertex> vertices = {
    ...
    {{ 0.5f, -0.5f,  0.5f}, {0.8f, 0.3f, 0.6f}}, // 右下
    {{ 0.5f,  0.5f,  0.5f}, {0.9f, 0.5f, 0.8f}}, // 右上
    {{-0.5f,  0.5f,  0.5f}, {1.0f, 0.6f, 0.9f}}, // 左上

    // ================= 后面 (Back) - 暗粉色系 =================
    {{ 0.5f, -0.5f, -0.5f}, {0.5f, 0.2f, 0.4f}}, // 左下
    {{-0.5f, -0.5f, -0.5f}, {0.4f, 0.1f, 0.3f}}, // 右下
    {{-0.5f,  0.5f, -0.5f}, {0.6f, 0.3f, 0.5f}}, // 右上
    {{ 0.5f,  0.5f, -0.5f}, {0.7f, 0.4f, 0.6f}}, // 左上

    // ================= 左面 (Left) - 暗蓝色系 =================
    {{-0.5f, -0.5f, -0.5f}, {0.0f, 0.2f, 0.5f}}, // 左下
    {{-0.5f, -0.5f,  0.5f}, {0.0f, 0.3f, 0.7f}}, // 右下
    {{-0.5f,  0.5f,  0.5f}, {0.1f, 0.5f, 0.9f}}, // 右上
    {{-0.5f,  0.5f, -0.5f}, {0.1f, 0.4f, 0.7f}}, // 左上

    // ================= 右面 (Right) - 明蓝色系 =================
    {{ 0.5f, -0.5f,  0.5f}, {0.1f, 0.5f, 0.9f}}, // 左下
    {{ 0.5f, -0.5f, -0.5f}, {0.0f, 0.4f, 0.8f}}, // 右下
    {{ 0.5f,  0.5f, -0.5f}, {0.2f, 0.6f, 0.9f}}, // 右上
    {{ 0.5f,  0.5f,  0.5f}, {0.3f, 0.7f, 1.0f}}, // 左上

    // ================= 上面 (Top) - 薄荷绿 =================
    {{-0.5f,  0.5f,  0.5f}, {0.3f, 0.9f, 0.8f}}, // 左下
    {{ 0.5f,  0.5f,  0.5f}, {0.1f, 0.8f, 0.7f}}, // 右下
    {{ 0.5f,  0.5f, -0.5f}, {0.2f, 0.9f, 0.8f}}, // 右上
    {{-0.5f,  0.5f, -0.5f}, {0.4f, 1.0f, 0.9f}}, // 左上

    // ================= 下面 (Bottom) - 灰色强渐变 (无对角线) =================
    // 呈现从亮灰到深黑灰的强烈渐变，满足平滑公式
    {{-0.5f, -0.5f, -0.5f}, {0.40f, 0.40f, 0.40f}}, // 左下 (中度灰)
    {{ 0.5f, -0.5f, -0.5f}, {0.60f, 0.60f, 0.60f}}, // 右下 (亮灰色)
    {{ 0.5f, -0.5f,  0.5f}, {0.40f, 0.40f, 0.40f}}, // 右上 (中度灰)
    {{-0.5f, -0.5f,  0.5f}, {0.20f, 0.20f, 0.20f}}  // 左上 (深黑灰)
};
